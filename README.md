...
1. By using your GitHub credentials, just click on the following link for instantiate a environment via GitPod: https://gitpod.io/#https://github.com/HWatanuki/HPCCSystems_ML_Pipeline
...
```
cd “C:\Program Files (x86)\HPCCSystems\8.4.12\clienttools\bin” 
...
**Note II**: The properties dataset is already sprayed and available in the training cluster utilized during the workshop and also available in the following link:https://github.com/HWatanuki/HPCCSystems_ML_Pipeline/raw/main/Data/properties.csv
